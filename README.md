...
- [X] Explain the difference between `Relational Databases` and `SQL`.
        ...
        A relational database is a type of database that stores and provides access to data points that are related to one another.
	      ...
	      sql is a query language that is used to communicate with the relational data base management system
          

- [X] Why do tables need a `primary key`?

        The primary key , allows us to query each table row individually and modify each row without altering other rows in the same table.
